...
export default function DeleteBrandModal({ Brand, className, showing, setShowing }: Props) {
    ...
    const deleteBrand = async (id: string) => {
        ...
        try {
            ...
            if (res.ok) {
                Notify.success('Xóa thương hiệu thành công', {
                    clickToClose: true,
                });
                router.refresh();
            }
            ...
            console.log(error);
            Notify.failure('Xóa thương hiệu không thành công');
        }
        Loading.remove();
    };
    return (
                        ...
                        <div className='sm:flex sm:items-start'>
                            ...
                            <div className='mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left'>
                                <h3
                                    ...
                                    id='modal-title'
                                >
                                    Xác nhận xóa thương hiệu {Brand.name}
                                </h3>
                                <div className='mt-2'>
