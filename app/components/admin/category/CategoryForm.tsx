...
const CategoryForm = (props: Props) => {
  ...
  const onSubmit = async (data: Data) => {
    ...
    if (props.mode === 'add') {
      try {
        ...
        Notify.failure('Thêm mới thất bại');
      }
    }
  ...
  return (
    ...
    <div
      className={(opeing?'absolute':'hidden') + ' z-10'}
    >
      ...
      >
        <div className='relateive w-fit min-w-[30%] max-h-full'>
          <div className='relative bg-white rounded-lg shadow dark:bg-gray-700'>
            ...
            <div
              className='px-6 py-6 lg:px-8 w-full'
            >
