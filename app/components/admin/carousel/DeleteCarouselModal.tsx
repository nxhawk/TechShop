...
const DeleteCarouselModal = ({ CarouselID, className, showing, setShowing }: Props) => {
  const deleteCarousel = async (id: string) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        Notify.success('Xóa ảnh bìa thành công', { clickToClose: true });
      } else {
        Notify.failure('Xóa ảnh bìa không thành công');
      }
    } catch (error) {
      Notify.failure('Xóa ảnh bìa không thành công');
    }
