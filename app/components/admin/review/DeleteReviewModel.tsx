...
const DeleteReviewModel = ({ ReviewId, className, showing, setShowing }: Props) => {
  const deleteReview = async (id: string) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        Notify.success('Xóa đánh giá thành công', { clickToClose: true });
      } else {
        Notify.failure('Xóa đánh giá không thành công');
      }
    } catch (error) {
      console.log(error);
    }
