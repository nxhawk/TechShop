...
const CarouselThumbnail = (props: CarouselThumbnailProps) => {
  ...
  return (
    <div
      className={`${length <= 5 ?"justify-center":"justify-around"} relative flex items-center w-full`}
    >
      <div
        className={`${length <= 5?"hidden":"absolute"} group-hover:block top-[50%] -translate-x-6 translate-y-[-50%] left-5 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer`}
      >
