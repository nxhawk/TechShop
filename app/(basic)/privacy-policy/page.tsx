export const metadata = {
  title: 'Chính sách bảo mật | TechWorld',
...
const Page = () => {
  ...
  return (
    <div className='flex flex-col space-y-4 w-full h-full mx-20 my-10'>
        <div className='text-2xl font-bold text-center'>CHÍNH SÁCH BẢO MẬT</div>
        <p className='whitespace-pre-line'>{p1}</p>
        <div className='text-lg font-semibold'>1. Thu thập thông tin cá nhân</div>
        <p className='whitespace-pre-line'>{p2}</p>
        <div className='text-lg font-semibold'>Điều lệ khác về thông tin cá nhân</div>
        <p className='whitespace-pre-line'>{p3}</p>
        <div className='text-lg font-semibold'>Đối tác thứ ba và Liên kết</div>
        <p className='whitespace-pre-line'>{p4}</p>
        <div className='text-lg font-semibold'>2. Quyền lợi khách hàng</div>
        <p>
